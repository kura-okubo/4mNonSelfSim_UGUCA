...
class SolverMethod:
    ...
    __members__: typing.ClassVar[
        dict[str, SolverMethod]
    ]  # value = {'static': <SolverMethod.static: 0>, 'quasi_dynamic': <SolverMethod.quasi_dynamic: 1>, 'dynamic': <SolverMethod.dynamic: 2>, 'adaptive': <SolverMethod.adaptive: 3>}
    ...
    quasi_dynamic: typing.ClassVar[
        SolverMethod
    ]  # value = <SolverMethod.quasi_dynamic: 1>
...
class SpatialDirection:
    ...
    __members__: typing.ClassVar[
        dict[str, SpatialDirection]
    ]  # value = {'x': <SpatialDirection.x: 0>, 'y': <SpatialDirection.y: 1>, 'z': <SpatialDirection.z: 2>, 'spatial_dir_count': <SpatialDirection.spatial_dir_count: 3>}
    spatial_dir_count: typing.ClassVar[
        SpatialDirection
    ]  # value = <SpatialDirection.spatial_dir_count: 3>
