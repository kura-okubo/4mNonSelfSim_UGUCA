...
class BarrasLaw(InterfaceLaw):
    def __init__(
        self,
        mesh: puguca.mesh.BaseMesh,
        tau_max_default: float,
        delta_c_default: float,
        name: str = "blaw",
    ) -> None: ...
...
class BimatInterface(Interface):
    def __init__(
        ...
        std: ...,
        std: ...,
        top_material: puguca.half_space.Material,
        bot_material: puguca.half_space.Material,
        law: ...,
        method: puguca.SolverMethod = ...,
    ) -> None: ...
    def advanceTimeStep(
        self, solver_method: puguca.SolverMethod, ts_factor: int = 1
    ) -> None: ...
    def closingNormalGapForce(
        self, arg0: puguca.mesh.NodalField, arg1: bool, arg2: int
    ) -> None: ...
