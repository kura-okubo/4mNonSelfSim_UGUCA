...
int main(){
  ...
  Kernel * kernel = pstrain.getKernel(Kernel::Krnl::H00);
  ...
  kernel = pstrain.getKernel(Kernel::Krnl::H01);
  ...
  kernel = pstrain.getKernel(Kernel::Krnl::H11);
  ...
  kernel = pstrain.getKernel(Kernel::Krnl::H22);
