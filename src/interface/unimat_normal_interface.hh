/**
 * @file   unimat_normal_interface.hh
 *
 ...
 */
#ifndef __UNIMAT_NORMAL_INTERFACE_H__
#define __UNIMAT_NORMAL_INTERFACE_H__
/* -------------------------------------------------------------------------- */
...
class UnimatNormalInterface : public Interface {
  /* ------------------------------------------------------------------------ */
  /* Constructors/Destructors                                                 */
  /* ------------------------------------------------------------------------ */
public:

  UnimatNormalInterface(FFTableMesh & mesh,
		       Material & top_material,
		       InterfaceLaw & law,
		       const SolverMethod & method = _dynamic);

  virtual ~UnimatNormalInterface();
...
#ifdef UCA_VERBOSE
    std::cout << "Warning: UnimatNormalInterface::getBot() returns the same "
	      << "HalfSpace as UnimatNormalInterface::getTop()" << std::endl;
#endif /* UCA_VERBOSE */
    return *(this->top);
  }
...
//#include "unimat_normal_interface_impl.cc"

#endif /* __UNIMAT_NORMAL_INTERFACE_H__ */
