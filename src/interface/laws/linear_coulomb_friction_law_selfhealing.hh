/**
 * @file   linear_coulomb_friction_law_selfhealing.hh
 *
 ...
 */
#ifndef __LINEAR_COULOMB_FRICTION_LAW_SELFHEALING_H__
#define __LINEAR_COULOMB_FRICTION_LAW_SELFHEALING_H__
/* -------------------------------------------------------------------------- */
...
class LinearCoulombFrictionLawSelfHealing : public InterfaceLaw {
  /* ------------------------------------------------------------------------ */
  /* Constructors/Destructors                                                 */
  /* ------------------------------------------------------------------------ */
public:

  LinearCoulombFrictionLawSelfHealing(BaseMesh & mesh,
			   double mu_s_default,
			   double mu_k_default,
			   double d_c_default,
  ...
  virtual ~LinearCoulombFrictionLawSelfHealing() {};
...
//#include "linear_coulomb_friction_law_selfhealing_impl.cc"

#endif /* __LINEAR_COULOMB_FRICTION_LAW_SELFHEALING_H__ */
