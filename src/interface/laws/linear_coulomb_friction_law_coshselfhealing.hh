/**
 * @file   linear_coulomb_friction_law_coshselfhealing.hh
 *
 ...
 */
#ifndef __LINEAR_COULOMB_FRICTION_LAW_COSHSELFHEALING_H__
#define __LINEAR_COULOMB_FRICTION_LAW_COSHSELFHEALING_H__
/* -------------------------------------------------------------------------- */
...
/*
   ...
   d_s characteristic strengthening length
...
class LinearCoulombFrictionLawCoshSelfHealing : public InterfaceLaw {
  /* ------------------------------------------------------------------------ */
  /* Constructors/Destructors                                                 */
  /* ------------------------------------------------------------------------ */
public:

  LinearCoulombFrictionLawCoshSelfHealing(BaseMesh & mesh,
			   double mu_s_default,
			   double mu_k_default,
			   double d_c_default,
			   double d_s_default, // characteristic strengthening distance
			   double char_reg_time = 0.);

  virtual ~LinearCoulombFrictionLawCoshSelfHealing() {};
...
public:
  ...
  NodalFieldComponent & getDs() { return this->d_s; };
...
private:
  ...
  NodalFieldComponent d_s; // strengthening distance
...
//#include "linear_coulomb_friction_law_coshselfhealing_impl.cc"

#endif /* __LINEAR_COULOMB_FRICTION_LAW_COSHSELFHEALING_H__ */
