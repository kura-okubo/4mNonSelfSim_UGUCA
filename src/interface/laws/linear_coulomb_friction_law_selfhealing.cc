/**
 * @file   linear_coulomb_friction_law_selfhealing.cc
 *
...
/* -------------------------------------------------------------------------- */
LinearCoulombFrictionLawSelfHealing::LinearCoulombFrictionLawSelfHealing(BaseMesh & mesh,
						   double mu_s_default,
						   double mu_k_default,
						   double d_c_default,
						   double d_s_default,
...
/* -------------------------------------------------------------------------- */
void LinearCoulombFrictionLawSelfHealing::computeCohesiveForces(NodalField & cohesion,
						     bool predicting) {
...
/* -------------------------------------------------------------------------- */
void LinearCoulombFrictionLawSelfHealing::computeRegContactPressure(NodalFieldComponent & cohesion_1,
...
/* -------------------------------------------------------------------------- */
void LinearCoulombFrictionLawSelfHealing::registerDumpField(const std::string & field_name) {
