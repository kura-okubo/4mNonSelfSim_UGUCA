/**
 * @file   unimat_normal_interface.cc
 *
...
/*-------------------------------------------------------------------------- */
UnimatNormalInterface::UnimatNormalInterface(FFTableMesh & mesh,
...
/* -------------------------------------------------------------------------- */
UnimatNormalInterface::~UnimatNormalInterface() {
  delete this->top;
}
...
/* -------------------------------------------------------------------------- */
void UnimatNormalInterface::maintainShearGapForce(NodalField & maintain_force) {
...
/* -------------------------------------------------------------------------- */
void UnimatNormalInterface::registerDumpField(const std::string & field_name) {
